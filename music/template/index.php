...
<head>
    ...
    <title>一星屋音乐-享你所想,触手可及 | 在线观看分享高清音乐短视频,搜索全网好听的歌</title>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color"><a href="../index.html">Mxyw<em>c</em><i class="am-icon-reply am-icon-fw"></i></a></h2>
                <p class="am-text-center">全网音乐搜索解决方案</p>
            </header>
            <hr>
            <div class="am-u-lg-12 am-padding-vertical">
                ...
                <form id="j-main" class="am-form am-u-md-12 am-u-sm-centered music-main">
                    <a type="button" id="j-back" class="am-btn am-btn-success am-btn-lg am-btn-block am-radius am-margin-bottom-lg">成功搜索&nbsp返回继续 <i class="am-icon-reply am-icon-fw"></i></a>
